...
`)}var Ce=3,$e="gol-recording",Me="raw-packed",mt="deflate-raw",bt=12,gt=256*1024*1024,In=512*1024*1024,ht=128*1024*1024*1024;function St(e,r,t=0){let n=t;for(let i of e)n+=i[r];return n}function Gn(e,r){return Math.min(e,r)}function yt(e){return Math.min(e,1073741824)}function Ln(e){return Math.min(e,In)}function Tt(e,r){return Math.max(e*2,r*6)}function xr(e,r){return e>0&&e<=r}function Bo(e,r){return e>0?e*2+r:0}function Po(e,r){return e>=1&&r>0?e*r*(1+Ce):0}function Eo(e,r){return e<gt?Math.min(gt,r):e}function Dn(e,r){return xr(e,r)?Math.max(1,Math.floor(Eo(e,r)/e)):0}function Br(e,r){return e>=1&&r>0?Math.max(1,Math.min(bt,Math.floor(536870912/(e*r)))):bt}function Fn(e,r,t,n,i,o){let s=!r.some(u=>u)&&(i||o>=e),a=i?Math.floor(n/2)+1:n;return e>=1&&r.length>0&&(s||t>=a)}function Un(e,r,t,n){return e<r&&n.some((i,o)=>t[o]&&i.mapState==="unmapped")}function On(e,r,t,n,i,o){return e&&r>=1&&t!==null&&n.length>0&&(i<r||o)}function $n(e,r,t,n,i){let o=Math.min(e.quota??ht/128,ht),s=e.usage??0,a=0,u=0;for(let f of r)f.codec===Me?a+=f.storedBytes:u+=f.storedBytes;let l=t*n,p=i?(1+Ce)*l:0;return{quotaBytes:o,usedBytes:s,pendingRawBytes:a,compressedBytes:u,gpuBufferMarginBytes:p}}function Nn(e,r,t,n,i){let o=yt(e);return{maxBytes:e,vramBudgetBytes:Tt(e,o),frameByteSize:r,recordingAvailable:xr(r,o),vramSimulationBytes:Bo(r,n),vramRecordingBytes:Po(t,r),gridFormat:i}}function Pr(e,r,t){r.length>0&&(e.generationStart=r[0].generationStart,e.generationEnd=r[r.length-1].generationEnd),t.length>0&&(r.length===0&&(e.generationStart=t[0]),e.generationEnd=t[t.length-1]),e.chunks=[...r]}function Wn(e){return e.map(r=>({...r,generations:[...r.generations]}))}function zn(e,r){return e!==r}function Er(e,r=0){return St(e,"blockCount",r)}function Kn(e){return St(e,"storedBytes")}function Xn(e){return St(e,"uncompressedBytes")}var ko=256,Ne=80,Yn=ko*Uint32Array.BYTES_PER_ELEMENT;function qn(e){let r=new ArrayBuffer(Ne),t=new Float32Array(r),n=new Int32Array(r),i=new Uint32Array(r),o=(e.offsetX%e.grid.cols+e.grid.cols)%e.grid.cols,s=(e.offsetY%e.grid.rows+e.grid.rows)%e.grid.rows,a=Math.floor(o),u=Math.floor(s);return t[0]=e.canvasWidth,t[1]=e.canvasHeight,t[2]=e.scale,t[4]=o-a,t[5]=s-u,i[6]=e.grid.cols,i[7]=e.grid.rows,i[8]=a,i[9]=u,i[10]=e.tribeCount,n[12]=e.brushPreview.centerX,n[13]=e.brushPreview.centerY,i[14]=e.brushPreview.brushSize,i[15]=e.brushPreview.shape,i[16]=e.brushPreview.visible?1:0,r}function Hn(e){let r=new Uint32Array(e.length);for(let t=0;t<e.length;t++){let n=e[t].color,i=parseInt(n.substring(0,2),16),o=parseInt(n.substring(2,4),16),s=parseInt(n.substring(4,6),16);r[t]=i|o<<8|s<<16}return r}function jn(e,r){return e.replace("__CELLS_PER_WORD__",`${r.cellsPerWord}u`).replace("__WORD_SHIFT__",`${r.wordShift}u`).replace("__CELL_SHIFT__",`${r.cellShift}u`).replace("__CELL_INDEX_MASK__",`${r.cellIndexMask}u`).replace("__CELL_MASK__",`${r.cellMask}u`)}var wo=500,Ao=33,Io=2,Go=.5,Vn=.2,Zn=1,Lo=1048576;function Qn(e){return Math.min(3,Math.max(0,Math.ceil(Math.log10(e.cols*e.rows/1e5))))}function We(e){return 1024/4**Qn(e)}function kr(e){return 16/2**Qn(e)}function Do(e){return Math.max(Zn,Math.round(We(e)*kr(e)))}function Jn(e,r){return{generationsPerDrain:Do(e),targetDrainMs:r.kind==="max"?wo:Ao,smoothedDrainMs:0,lastDrainStartedAt:0,lastSubmittedGenerations:0}}function ei(e,r){if(r>0&&e.lastSubmittedGenerations>0){let t=e.smoothedDrainMs===0?r:e.smoothedDrainMs*(1-Vn)+r*Vn,n=Math.min(Io,Math.max(Go,e.targetDrainMs/t));e.smoothedDrainMs=t,e.generationsPerDrain=Math.max(Zn,Math.min(Lo,Math.round(e.generationsPerDrain*n)))}}function Ct(e,r){return e==="recording"?Number.MAX_SAFE_INTEGER:We(r)*kr(r)}function Mt(e,r,t,n,i){let o=e-r*n;return t>n||t>i?Math.min(o,r):o}function ri(e){return e<=0?{kind:"max"}:{kind:"fixedGenPerSecond",genPerSecond:1e3/e}}function Y(e){return e.request.stopCondition.kind==="targetGeneration"}function ve(e,r){return e.request.stopCondition.kind==="targetGeneration"&&r>=e.request.stopCondition.generation}function ze(e,r){return e.request.stopCondition.kind==="targetGeneration"?Math.max(0,e.request.stopCondition.generation-r):Number.POSITIVE_INFINITY}function ti(e,r){return r.restore!==!1&&e.request.restoreAfterStop||null}function ni(e,r,t){return r&&t.postStepping!==!1&&(e==="targetReached"||e==="cancelled")}function ii(e,r,t,n,i){return e.restartRestoredRun!==!1&&r&&t&&!n&&!i}function oi(e,r,t,n){let i=r+t,o=Math.min(n,i-1);if(o<=0)return null;let s=i-1-o;if(s>=r)return{source:"buffered",frameInChunk:s-r};let a=0;for(let u=0;u<e.length;u++){let l=e[u];if(s<a+l.blockCount)return{source:"sealed",sealedIndex:u,frameInChunk:s-a};a+=l.blockCount}return null}function ai(e,r){return{chunkFrameIndex:r.frameInChunk+1,generation:e[r.frameInChunk]}}function si(e,r,t,n,i,o){let s=(r+1)*t;if(i.bitsPerCell===o.bitsPerCell)return{sameFormat:!0,chunkPrefix:new Uint8Array(e,0,s),activeFrame:null};let a=Q(n,i),u=new Uint8Array(s);for(let l=0;l<=r;l++){let p=new Uint8Array(e,l*a,a),f=Cr(tn(p),n,i,o);u.set(new Uint8Array(f.buffer,f.byteOffset,f.byteLength),l*t)}return{sameFormat:!1,chunkPrefix:u,activeFrame:u.subarray(r*t,s)}}var c,A=!1,$r,wr,pe,Hr,_=0,x=0,jr=0,B=ur,Be=[],Pe=new Map,Nr,xt,G,L,Ee,Re,Ve,Bt,Pt,Ye,Ot,$t,w=!1,di=1,fi=0,pi=0,P=!1,I=!1,ne=100,b=0,me=0,Ke=0,Vr=0,Ar,Fo=4,Nt=192,fe=[],Wr=[],zr=[],Uo=0,Ir=null,mi={centerX:0,centerY:0,brushSize:1,shape:0,visible:!1},ie=null,Gr=-1,_e=!1,qe=!1,vt=0,Ze=lr,Lr=[],R=!1,z=!1,ee={chunks:[],generationStart:0,generationEnd:0,gridFormat:Ie(ur)},bi=0,C=[],Qe=!1,g=null,gi=0,Dr=!1,F=null,h=0,v=[],be=null,T=64,y=0,oe=[],W=[],He=null,le=null,K=0,Je=0,de=0,q=!1,Xe=0,Fr=0,Ur=0,je=[];function Oo(e){switch(!0){case e instanceof Error:return e.message;case typeof e=="string":return e;case(e&&typeof e=="object"&&"message"in e&&typeof e.message=="string"):return e.message;default:return String(e??"Unknown worker error")}}function hi(e){console.error("[GOLT worker] Worker GPU error:",e),E("error",{render:!1,postStepping:!1,restore:!1,restartRestoredRun:!1}),P=!1,self.postMessage({type:"gpuError",reason:Oo(e)})}self.addEventListener("error",e=>{e.preventDefault(),hi(e.error??e.message)});self.addEventListener("unhandledrejection",e=>{e.preventDefault(),hi(e.reason)});async function Wt(){await c.queue.onSubmittedWorkDone()}function ui(e){Fr=0,Ur=2+(e?1+Ce:0),je=[]}async function Kr(){if(je.length>0){let e=c.createCommandEncoder({label:d.trackedAllocationClearEncoder});for(let r of je)e.clearBuffer(r);c.queue.submit([e.finish()]),await Wt(),je=[]}}async function Xr(e,r){I&&Ur>0&&(Fr+=e,Ur--,je.push(r),Fr>=Ln(ge())&&Ur>0&&(await Kr(),Fr=0))}function Yr(){F?.destroy(),F=null;for(let e of oe)e?.destroy();oe=[],W=[],T=0,h=0,v=[],be=null,Je=0}function ci(){G?.destroy(),L?.destroy(),pn(ie),ie=null,fe.forEach(e=>e.destroy()),fe=[],Wr=[],zr=[],Yr()}function Rt(e){let r=K>0;K+=e;let t=K>0;r!==t&&self.postMessage({type:"chunksSaving",active:t})}function xe(){let e=Fn(T,W,de,Br(T,y),q,h);e!==q&&(q=e,self.postMessage({type:"backpressure",active:e}))}async function we(){self.postMessage({type:"storageQuota",...$n(await navigator.storage.estimate(),C,T,y,R)})}function ge(){return Gn(c.limits.maxBufferSize,c.limits.maxStorageBufferBindingSize)}function rr(){return yt(ge())}function re(){return xr(y,rr())}function Si(){return Un(de,Br(T,y),W,oe)}function er(){return On(re(),T,F,oe,h,Si())}async function $o(e){let r=new DecompressionStream(mt),t=r.writable.getWriter();t.write(new Uint8Array(e)),t.close();let n=[],i=r.readable.getReader();for(;;){let{done:u,value:l}=await i.read();if(u)break;n.push(l)}let o=0;for(let u of n)o+=u.byteLength;let s=new Uint8Array(o),a=0;for(let u of n)s.set(u,a),a+=u.byteLength;return s.buffer}function j(){return{cols:_,rows:x}}function No(){return pt(Math.ceil(jr/16),Math.ceil(x/16),c.limits.maxComputeWorkgroupsPerDimension)}function Wo(){return pt(Math.ceil(_/16),Math.ceil(x/16),c.limits.maxComputeWorkgroupsPerDimension)}function Et(){Ee?.destroy(),Ee=c.createBuffer({label:d.uniformBuffer,size:Ne,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}function zo(){let e=qn({canvasWidth:pe.width,canvasHeight:pe.height,scale:di,offsetX:fi,offsetY:pi,grid:j(),tribeCount:Be.length,brushPreview:mi});c.queue.writeBuffer(Ee,0,e)}function Zr(){return Q({cols:_,rows:x},B)}function ae(){return Ie(B)}async function kt(){let e=Zr();G=c.createBuffer({label:d.gridBufferA,size:e,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),await Xr(e,G),L=c.createBuffer({label:d.gridBufferB,size:e,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),await Xr(e,L);let r=c.createCommandEncoder({label:d.gridClearEncoder});r.clearBuffer(G),r.clearBuffer(L),c.queue.submit([r.finish()]),w=!1}function wt(){let e=Hn(Be);Re&&Re.destroy(),Re=c.createBuffer({label:d.tribeColorBuffer,size:e.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),c.queue.writeBuffer(Re,0,e)}function At(){let e=c.createShaderModule({label:d.renderShaderModule,code:jn(Qt,B)});Ve=c.createRenderPipeline({label:d.renderPipeline,layout:"auto",vertex:{module:e,entryPoint:"vs_main"},fragment:{module:e,entryPoint:"fs_main",targets:[{format:wr}]},primitive:{topology:"triangle-list"}})}function It(){Bt=c.createBindGroup({layout:Ve.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:Ee}},{binding:1,resource:{buffer:G}},{binding:2,resource:{buffer:Re}}]}),Pt=c.createBindGroup({layout:Ve.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:Ee}},{binding:1,resource:{buffer:L}},{binding:2,resource:{buffer:Re}}]})}function Gt(){Nr=No();let e=An(Hr,Be,jr,j(),Nr,B,Pe),r=c.createShaderModule({label:d.simulationShaderModule,code:e});Ye=c.createComputePipeline({label:d.simulationPipeline,layout:"auto",compute:{module:r,entryPoint:"main"}}),Ot=c.createBindGroup({layout:Ye.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:G}},{binding:1,resource:{buffer:L}}]}),$t=c.createBindGroup({layout:Ye.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:L}},{binding:1,resource:{buffer:G}}]})}function Lt(){xt=Wo(),ie=fn({device:c,cols:_,rows:x,gridFormat:B,dispatchPlan:xt})}function Dt(){let e=c.createShaderModule({label:d.brushShaderModule,code:Tn(B)});Ar=c.createComputePipeline({label:d.brushPipeline,layout:"auto",compute:{module:e,entryPoint:"main"}}),fe.forEach(r=>r.destroy()),fe=[],Wr=[],zr=[];for(let r=0;r<Fo;r++){let t=c.createBuffer({label:`${d.brushUniformBuffer} ${r}`,size:Nt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});fe.push(t),Wr.push(c.createBindGroup({layout:Ar.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:G}},{binding:1,resource:{buffer:t}}]})),zr.push(c.createBindGroup({layout:Ar.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:L}},{binding:1,resource:{buffer:t}}]}))}}function Ko(e,r,t,n,i,o,s){let a=Pe.get(M)??0,u=Uo++,l=Cn(r,t,n,j()),p=w?zr:Wr;for(let[f,m]of l.entries()){let D=new ArrayBuffer(Nt),S=new Uint32Array(D);S[0]=jr,S[1]=n,S[2]=i,S[3]=o,S[4]=a,S[5]=u,S[6]=s.length,S[7]=m.destinationStartX,S[8]=m.destinationStartY,S[9]=m.localStartX,S[10]=m.localStartY,S[11]=m.spanCols,S[12]=m.spanRows,S[13]=0;for(let O=0;O<s.length&&O<32;O++)S[14+O]=s[O];let U=fe[f],se=p[f];if(U&&se){c.queue.writeBuffer(U,0,D);let O=Math.floor(m.destinationStartX/B.cellsPerWord),Di=Math.ceil((m.destinationStartX+m.spanCols)/B.cellsPerWord)-O,Fi=Math.ceil(Di/8),Ui=Math.ceil(m.spanRows/8),sr=e.beginComputePass({label:d.brushPass});sr.setPipeline(Ar),sr.setBindGroup(0,se),sr.dispatchWorkgroups(Fi,Ui),sr.end()}else throw console.error("[GOLT worker] Brush dispatch resources are out of sync with the wrapped brush rectangles.",{index:f,rectCount:l.length,bindGroupCount:p.length,uniformBufferCount:fe.length}),new Error("Brush dispatch resources are out of sync with the wrapped brush rectangles.")}}function Xo(){let e=w?L:G,r=Zr(),t;try{t=c.createBuffer({label:d.gridReadbackBuffer,size:r,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST})}catch(i){return console.warn("GPU readback buffer allocation failed:",i),Promise.reject(new Error(`Failed to allocate ${r} byte readback buffer`))}let n=c.createCommandEncoder({label:d.gridReadbackEncoder});return n.copyBufferToBuffer(e,0,t,0,r),c.queue.submit([n.finish()]),t.mapAsync(GPUMapMode.READ).then(()=>{let i=new Uint32Array(t.getMappedRange().slice(0));return t.unmap(),t.destroy(),i})}function yi(){y=Zr(),T=Dn(y,rr())}function Ft(){self.postMessage({type:"limits",...Nn(ge(),y,T,Ne+Yn+Nt+Se*2+ye*2,ae())})}function tr(e){if(T>=1&&F!==null&&h<T){let r=w?L:G,t=h*y,n=c.createCommandEncoder({label:d.recordingFrameCopyEncoder});n.copyBufferToBuffer(r,0,F,t,y),c.queue.submit([n.finish()]),v.push(e),be=e,h++,Or()}}function _t(e){Je=Math.max(0,Je+e)}function Or(){T>0&&h>=T&&Si()&&nr()}function nr(){let e=F;if(e!==null&&h>0&&oe.length>0&&de<Br(T,y)){let r=W.indexOf(!0);if(r>=0){W[r]=!1;let t=oe[r];if(t.mapState==="unmapped"){let n=h*y,i=bi++,o=[...v],s=o[0],a=o[o.length-1],u=`chunk-${String(i).padStart(6,"0")}.bin`,l=h,p=c.createCommandEncoder({label:d.recordingSealCopyEncoder});p.copyBufferToBuffer(e,0,t,0,n),c.queue.submit([p.finish()]);let f={chunkId:i,generationStart:s,generationEnd:a,blockCount:l,codec:Me,uncompressedBytes:n,storedBytes:n,gridFormat:ae(),generations:o,filename:u};Rt(1),_t(l),de++,xe();let m=Xe;t.mapAsync(GPUMapMode.READ).then(async()=>{let D=t.getMappedRange(),S=new ArrayBuffer(n);new Uint8Array(S).set(new Uint8Array(D,0,n)),t.unmap(),m===Xe&&(W[r]=!0,C.push(f),_t(-l),Pr(ee,C,v),xe(),Or(),Yo(f,S).then(()=>{m===Xe&&(de--,xe(),Rt(-1),we(),qr(),V(!0),Or(),self.postMessage({type:"chunkSealed",filename:f.filename,rawBytes:n,blockCount:f.blockCount,cols:_,rows:x,rawGridFormat:f.gridFormat,storageGridFormat:Ie(cr(Hr.tribes.length))}),Qe&&K===0&&(Qe=!1,qr()))}))}).catch(()=>{m===Xe&&(W[r]=!0,de--,_t(-l),xe(),Rt(-1),Or())}),h=0,v=[]}else W[r]=!0}}}async function Ti(e){Xe++,bi=0,h=0,v=[],C=[],be=null,Je=0,de=0,K>0&&(K=0,self.postMessage({type:"chunksSaving",active:!1})),q&&(q=!1,self.postMessage({type:"backpressure",active:!1})),Qe=!1,z=R,ee={chunks:[],generationStart:e,generationEnd:e,gridFormat:ae()},await Ci(),we()}async function zt(){return le&&await le,He||(He=await(await navigator.storage.getDirectory()).getDirectoryHandle($e,{create:!0})),He}async function Yo(e,r){let i=await(await(await zt()).getFileHandle(e.filename,{create:!0})).createWritable();await i.write(r),await i.close()}async function qo(e){let r=await zt();for(let t of e)try{await r.removeEntry(t)}catch(n){console.warn(`Failed to remove OPFS entry ${t}:`,n)}}async function Ci(){if(le)await le;else{le=(async()=>{let e=await navigator.storage.getDirectory();He=null;try{await e.removeEntry($e,{recursive:!0})}catch(r){r instanceof DOMException&&r.name==="NotFoundError"||console.warn(`Failed to remove OPFS directory ${$e}:`,r)}He=await e.getDirectoryHandle($e,{create:!0})})();try{await le}finally{le=null}}}function qr(){Pr(ee,C,v),self.postMessage({type:"recording",manifest:{chunks:Wn(C),generationStart:ee.generationStart,generationEnd:ee.generationEnd,gridFormat:ae()},cols:_,rows:x})}function ir(e=!1){if(R){let r=!z;e&&z&&er()&&(z=!1,r=!0),r&&zn(be,b)&&er()&&(h>=T&&nr(),tr(b))}}function Kt(){if(Ir){let e=Ir;Ir=null;let r=R&&h>0&&v[h-1]===b;r&&(h--,v.pop());let t=c.createCommandEncoder({label:d.brushEncoder});Ko(t,e.centerX,e.centerY,e.brushSize,e.shape,e.fill,e.tribeIds),c.queue.submit([t.finish()]),r&&tr(b)}}async function Ho(e,r=Me){let o=await(await(await(await zt()).getFileHandle(e)).getFile()).arrayBuffer();return r===mt?$o(o):o}function Mi(){return sn(_,x,Ze.enabled,Ze.sections)}function jo(){return un(Mi())}function vi(e){Lr=jo(),ie&&Lr.length>0&&mn({device:c,encoder:e,resources:ie,sourceBuffer:w?L:G,dispatchPlan:xt,enabledSections:Lr})}function Ri(){let e=b;if(ie&&e!==Gr&&!_e){let r=[...Lr],t=Mi();Gr=e,_e=!0,bn({resources:ie,enabledSections:r}).then(n=>{let i=Pe.get(M)??0,o=Er(C,h+Je),s=gn({generation:e,tribes:Be,deadTribeIndex:i,readback:n,enabledSections:r,availability:t,liveMetricSettings:Ze.sections,cols:_,rows:x,totalFrames:o,fps:Vr,canStepBack:o>1,recordingBytes:Kn(C),recordingRawBytes:Xn(C)});if(_e=!1,self.postMessage(s),qe)if(qe=!1,Gr=-1,xi()){let a=c.createCommandEncoder({label:d.interactiveMetricsEncoder});vi(a),c.queue.submit([a.finish()]),Ri()}else qe=!0}).catch(()=>{_e=!1})}}function Vo(e){if(e>0){let r=Nr,t=c.createCommandEncoder({label:d.simulationBatchEncoder});for(let n=0;n<e;n++){let i=t.beginComputePass({label:d.simulationStepPass});i.setPipeline(Ye),i.setBindGroup(0,w?$t:Ot),i.dispatchWorkgroups(r.dispatchWgX,r.dispatchWgY),i.end(),w=!w,b++}c.queue.submit([t.finish()]),me+=e}}function Zo(){self.postMessage({type:"generation",generation:b,fps:Vr})}function Xt(){let e=c.createCommandEncoder({label:d.simulationSingleStepEncoder}),r=e.beginComputePass({label:d.simulationStepPass});r.setPipeline(Ye),r.setBindGroup(0,w?$t:Ot);let t=Nr;r.dispatchWorkgroups(t.dispatchWgX,t.dispatchWgY),r.end(),c.queue.submit([e.finish()]),w=!w,b++}function H(){if(c&&$r&&Ee&&Ve&&Bt&&Pt&&!I&&!A){zo();let e=$r.getCurrentTexture().createView(),r=c.createCommandEncoder({label:d.renderEncoder}),t=r.beginRenderPass({label:d.renderPass,colorAttachments:[{view:e,loadOp:"clear",storeOp:"store",clearValue:{r:0,g:0,b:0,a:1}}]});t.setPipeline(Ve),t.setBindGroup(0,w?Pt:Bt),t.draw(3),t.end(),c.queue.submit([r.finish()])}}function _i(e){Ke===0&&(Ke=e);let r=e-Ke;r>=1e3&&(Vr=me/(r/1e3),me=0,Ke=e)}function Yt(){me=0,Ke=0,Vr=0}function qt(){return R&&re()?"recording":"nonRecording"}function xi(){return!!(c&&ie&&!I&&!A)}function V(e=!1){if(e&&(Gr=-1),!xi())qe=!0;else if(_e)qe=!0;else{let r=c.createCommandEncoder({label:d.interactiveMetricsEncoder});vi(r),c.queue.submit([r.finish()]),Ri()}}function Bi(){V(!0),H()}function Qr(e,r){r&&(e-vt>=1e3||vt===0)&&!_e&&(vt=e,V())}function or(e,r){(e.request.pacing.kind==="max"||Y(e))&&r-e.lastProgressTime>=1e3&&(e.lastProgressTime=r,Zo())}function ke(e){q!==e&&(q=e,self.postMessage({type:"backpressure",active:e}))}function Ht(){let e=er();return e&&h>=T&&(nr(),e=er()),e}function ar(){!I&&!A&&!g&&self.requestAnimationFrame(Ut)}function Qo(e,r){let t=e.adaptiveBatch;t&&t.lastDrainStartedAt>0&&(ei(t,r-t.lastDrainStartedAt),t.lastDrainStartedAt=0,t.lastSubmittedGenerations=0)}function Pi(e,r,t){let n=e.adaptiveBatch;n&&r>0&&(n.lastSubmittedGenerations=r,n.lastDrainStartedAt=t)}function Ei(e,r){let t=Math.max(1,Math.round(We(r))),n=0;for(;n<e;){let i=e-n,o=Math.min(t,i);Vo(o),n+=o}return n}function he(e){let r=g;if(r&&!r.pumpPending&&!I&&!A){let{token:t}=r;r.pumpPending=!0;let n=()=>{if(g&&g.token===t){let i=performance.now();g.pumpPending=!1,e==="drain"&&Qo(g,i),oa(i)}};e==="raf"?self.requestAnimationFrame(()=>n()):e==="drain"?c.queue.onSubmittedWorkDone().then(n).catch(()=>{g?.token===t&&(g.pumpPending=!1)}):queueMicrotask(n)}}function jt(e,r){g&&E("restart",{render:!1,postStepping:!1,restore:!1,restartRestoredRun:!1});let t=j(),n=e==="nonRecording"?Jn(t,r.pacing):null;n&&console.info("[GOLT worker] Adaptive non-recording batching started",{cols:t.cols,rows:t.rows,bitsPerCell:B.bitsPerCell,generationsPerDrain:n.generationsPerDrain,targetDrainMs:n.targetDrainMs}),g={kind:e,request:r,token:++gi,pumpPending:!1,lastFrameTime:0,stepAccumulator:0,lastProgressTime:0,lastRenderTime:0,adaptiveBatch:n},he(r.pacing.kind==="fixedGenPerSecond"?"raf":"microtask")}function te(){P&&jt(qt(),{pacing:ri(ne),stopCondition:{kind:"none"}})}function Jo(e,r){r||e==="cancelled"?ke(!1):q&&xe()}function E(e,r={}){let t=g;if(t){g=null,gi++;let n=Y(t),i=ti(t,r),o=!!i;i&&(P=i.running,ne=i.targetStepDuration),ni(e,n,r)&&self.postMessage({type:"stepping",active:!1}),Jo(e,n),r.render!==!1&&!I&&!A&&Bi(),ii(r,o,P,I,A)?te():ar()}}function ki(e){let r=g;r&&Y(r)&&(r.request.restoreAfterStop&&(r.request.restoreAfterStop.running=e),E("cancelled"))}function ea(e){E("restart",{render:!1,postStepping:!1,restore:!1,restartRestoredRun:!1}),jt(qt(),e)}function wi(e,r,t){ke(!0),or(e,r),Qr(r,t),he("drain")}function ra(e,r){let t=j(),n=e.adaptiveBatch?.generationsPerDrain??Math.round(We(t)*kr(t)),i=Math.min(n,ze(e,b)),o=Ei(i,t),s=o>0;or(e,r),ve(e,b)?E("targetReached"):s?(Pi(e,o,performance.now()),he("drain")):he("raf")}function ta(e,r){ir(!0);let t=!1,n=!1,i=performance.now()+14;for(;ze(e,b)>0&&performance.now()<i;)if(Ht())Xt(),me++,t=!0,tr(b);else{wi(e,r,t),n=!0;break}n||(ke(!1),or(e,r),Qr(r,t),ve(e,b)?E("targetReached"):he("raf"))}function na(e,r,t){e.lastFrameTime===0&&(e.lastFrameTime=t);let n=t-e.lastFrameTime;e.lastFrameTime=t,e.stepAccumulator+=n;let i=e.stepAccumulator,o=Math.floor(e.stepAccumulator/r),s=j(),a=e.adaptiveBatch?.generationsPerDrain??Ct(e.kind,s),u=Math.min(o,ze(e,b),a),l=Ei(u,s),p=l>0;if(e.stepAccumulator=Mt(i,r,o,l,a),or(e,t),ve(e,b))E("targetReached");else{let f=p&&o>l;(!Y(e)&&!f||t-e.lastRenderTime>=33||e.lastRenderTime===0)&&(e.lastRenderTime=t,H(),Qr(t,p)),f&&Pi(e,l,performance.now()),he(f?"drain":"raf")}}function ia(e,r,t){ir(!0),e.lastFrameTime===0&&(e.lastFrameTime=t);let n=t-e.lastFrameTime;e.lastFrameTime=t,e.stepAccumulator+=n;let i=!1,o=0,s=e.stepAccumulator,a=Ct(e.kind,j()),u=Math.floor(e.stepAccumulator/r),l=performance.now()+14,p=!1;for(;e.stepAccumulator>=r&&ze(e,b)>0&&o<a&&performance.now()<l;)if(Ht())Xt(),me++,o++,e.stepAccumulator-=r,i=!0,tr(b);else{wi(e,t,i),p=!0;break}e.stepAccumulator=Mt(s,r,u,o,a),p||(ke(!1),or(e,t),ve(e,b)?E("targetReached"):(Y(e)||(H(),Qr(t,i)),he("raf")))}function oa(e){let r=g;if(r&&!I&&!A)if(_i(e),Y(r)||Kt(),ve(r,b))E("targetReached");else if(r.request.pacing.kind==="max")r.kind==="recording"?ta(r,e):ra(r,e);else{let t=1e3/r.request.pacing.genPerSecond;r.kind==="recording"?ia(r,t,e):na(r,t,e)}}function Ut(e){I||A?self.requestAnimationFrame(Ut):(_i(e),g||(Kt(),ne>0&&!Dr&&H(),self.requestAnimationFrame(Ut)))}function aa(e,r){let t=c?ge():Number.POSITIVE_INFINITY;return Jt(r.bitsPerCell)&&tt(r.bitsPerCell,e.tribes.length)&&nt(e,Ae(r.bitsPerCell),t)?Ae(r.bitsPerCell):rn(e.tribes.length,e,t)}function Ai(e,r){Hr=e,_=e.cols,x=e.rows,B=aa(e,r),jr=ue(_,B),Be=[...e.tribes],ee.gridFormat=ae(),Pe.clear(),Be.forEach((t,n)=>Pe.set(t.id,n))}async function Ii(e){console.log("[GOLT worker] Initializing WebGPU"),pe=e,c=await on(d.webengineDevice),A=!1,c.lost.then(t=>{let n=t.message||t.reason||"unknown";console.error("[GOLT worker] GPU device lost:",n),E("deviceLost",{render:!1,postStepping:!1,restore:!1,restartRestoredRun:!1}),A=!0,P=!1,I=!0,self.postMessage({type:"deviceLost",reason:n})}),self.postMessage({type:"limits",maxBytes:ge(),vramBudgetBytes:Tt(ge(),rr()),frameByteSize:0,recordingAvailable:!0,vramSimulationBytes:0,vramRecordingBytes:0,gridFormat:ae()});let r=pe.getContext("webgpu");if(r)$r=r,wr=navigator.gpu.getPreferredCanvasFormat(),$r.configure({device:c,format:wr,alphaMode:"opaque"}),console.log("[GOLT worker] WebGPU initialized",{canvasFormat:wr,maxBufferSize:c.limits.maxBufferSize,maxStorageBufferBindingSize:c.limits.maxStorageBufferBindingSize});else throw new Error("WebGPU canvas context not available")}async function sa(){try{return console.log("[GOLT worker] Restoring WebGPU device"),await Ii(pe),console.log("[GOLT worker] WebGPU device restored"),!0}catch(e){let r=e instanceof Error?e.message:String(e);return console.error("[GOLT worker] WebGPU device restore failed:",r),E("deviceLost",{render:!1,postStepping:!1,restore:!1,restartRestoredRun:!1}),A=!0,P=!1,I=!0,self.postMessage({type:"deviceLost",reason:r}),!1}}async function Gi(){F=c.createBuffer({label:d.recordingChunkBuffer,size:T*y,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),await Xr(T*y,F),h=0,v=[],be=null}async function Li(){let e=T*y;oe=[],W=[];for(let r=0;r<Ce;r++){let t=c.createBuffer({label:`${d.recordingStagingBuffer} ${r}`,size:e,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST});oe.push(t),W.push(!0),await Xr(e,t)}}async function ua(){await Ci()}async function ca(){console.log("[GOLT worker] Building GPU resources",{cols:_,rows:x,bitsPerCell:B.bitsPerCell,recordingAvailable:re()}),Et(),yi(),await kt(),wt(),At(),It(),Gt(),Dt(),Lt(),await ua(),re()?(await Gi(),await Li()):(console.warn("[GOLT worker] Recording buffers disabled for current frame size",{frameByteSize:y,maxRecordingBufferBytes:rr()}),Yr(),R=!1,z=!1),await Kr(),Ft(),console.log("[GOLT worker] GPU resources ready")}async function la(){console.log("[GOLT worker] Rebuild started",{cols:_,rows:x,bitsPerCell:B.bitsPerCell}),E("rebuild",{render:!1,postStepping:!1,restore:!1,restartRestoredRun:!1}),I=!0,self.postMessage({type:"rebuilding",active:!0});try{await Wt()}catch{console.warn("[GOLT worker] Queue idle wait rejected during rebuild")}let e=!A;if(A&&(e=await sa()),e){ci(),Et(),yi(),ui(re());try{await kt(),wt(),At(),Gt(),Dt(),It(),Lt(),re()?(await Gi(),await Li()):(Yr(),R=!1,z=!1),await Kr(),Ft()}catch(r){let t=r instanceof Error?r.message:String(r);console.error("[GOLT worker] GPU rebuild failed:",t),self.postMessage({type:"gpuError",reason:t});try{ci(),Et(),ui(!1),await kt(),wt(),At(),Gt(),Dt(),It(),Lt(),R=!1,z=!1,y=Zr(),Yr(),console.warn("[GOLT worker] GPU rebuild recovered with recording disabled"),await Kr(),Ft()}catch(n){console.error("[GOLT worker] GPU rebuild recovery failed:",n),e=!1}}}return e&&(I=!1,self.postMessage({type:"rebuilding",active:!1}),console.log("[GOLT worker] Rebuild completed",{recordingAvailable:re(),frameByteSize:y})),e}function li(e){Dr=!0,c.queue.onSubmittedWorkDone().then(()=>{Dr=!1,e()}).catch(()=>{Dr=!1})}async function da(){K>0&&await new Promise(e=>{let r=setInterval(()=>{K===0&&(clearInterval(r),e())},10)})}async function fa(e){console.log("[GOLT worker] Init message received",{cols:e.ruleset.cols,rows:e.ruleset.rows,recording:e.recording,running:e.running,speed:e.speed}),R=e.recording,Ze=at(e.liveMetrics),z=R,Ai(e.ruleset,e.simulationGridFormat),await Ii(e.canvas),await ca(),V(!0),we(),P=e.running,ne=e.speed<0?0:1e3/e.speed,P?te():ar()}function pa(e){Ze=at(e.liveMetrics),V(!0)}async function ma(e){console.log("[GOLT worker] Ruleset update received",{cols:e.ruleset.cols,rows:e.ruleset.rows,tribes:e.ruleset.tribes.length});let r=ge();if(it(e.ruleset.tribes.length,e.ruleset,r))E("rebuild",{render:!1,postStepping:!1,restore:!1,restartRestoredRun:!1}),Ai(e.ruleset,e.simulationGridFormat),await la()&&(b=0,Yt(),await Ti(0),V(!0),P?te():ar());else{let i=`Requested ruleset requires at least ${en(e.ruleset.tribes.length).bitsPerCell}-bit packing, which exceeds the current GPU frame size limit.`;console.error("[GOLT worker] Rebuild rejected:",i,{cols:e.ruleset.cols,rows:e.ruleset.rows,tribes:e.ruleset.tribes.length,maxBytes:r}),self.postMessage({type:"gpuError",reason:i})}}function ba(e){P=e.running,e.running?g||te():g&&Y(g)?ki(!1):g?E("manual"):(q&&xe(),Bi(),ar())}function ga(e){let r=ne<=0,t=e.speed<0?0:1e3/e.speed;ne=t,g&&!Y(g)&&P?(E("restart",{render:!1,postStepping:!1,restore:!1,restartRestoredRun:!1}),r&&t>0?li(()=>{H(),te()}):te()):P&&!g?te():r&&t>0&&li(()=>{H(),ar()})}function ha(e){di=e.scale,fi=e.offsetX,pi=e.offsetY}function Sa(e){pe.width=e.width,pe.height=e.height}function ya(e){let r=e.tribes.map(t=>Pe.get(t)).filter(t=>t!==void 0);if(r.length>0){let t={square:0,round:1,diamond:2,vline:3,hline:4},n={full:0,spray:1,outline:2};Ir={centerX:e.x,centerY:e.y,brushSize:e.size,shape:t[e.shape]??0,fill:n[e.fill]??0,tribeIds:r}}}function Ta(e){let r={square:0,round:1,diamond:2,vline:3,hline:4};mi={centerX:e.x,centerY:e.y,brushSize:e.size,shape:r[e.shape]??0,visible:e.visible},!g&&!I&&!A&&ne<=0&&H()}async function Ca(){try{let e=await Xo();st({type:"snapshot",grid:e,generation:b,cols:_,rows:x,gridFormat:ae()},[e.buffer])}catch{let e=new Uint32Array(0);st({type:"snapshot",grid:e,generation:b,cols:_,rows:x,gridFormat:ae()},[e.buffer])}}async function Ma(e){let r=ot(e.gridFormat),t=j();if(e.grid.byteLength===Q(t,r)){let n=Cr(e.grid,t,r,B);c.queue.writeBuffer(w?L:G,0,n),b=e.generation,Yt(),await Ti(e.generation)}}function va(e){let r=g?.request,t=re();e.recording&&t&&!R?(R=!0,z=!0,V(!0),we()):(!e.recording||!t)&&(e.recording&&!t&&console.warn("[GOLT worker] Recording requested but unavailable for current frame size",{frameByteSize:y,maxRecordingBufferBytes:rr()}),R=!1,z=!1),r&&g?ea(r):!g&&P&&te()}async function Ra(){Qe||(await Wt(),ir(!1),h>0&&nr(),K>0?Qe=!0:qr())}async function _a(e){let r=Er(C),t=oi(C,r,h,e.count);if(t){let n=w?L:G;if(t.source==="buffered"){let i=ai(v,t);h=i.chunkFrameIndex,v.length=h,b=i.generation,be=b;let o=c.createCommandEncoder({label:d.recordingRestoreCopyEncoder});o.copyBufferToBuffer(F,t.frameInChunk*y,n,0,y),c.queue.submit([o.finish()])}else{K>0&&(await da(),r=Er(C));let i=C[t.sealedIndex],o=await Ho(i.filename,i.codec),s=j(),a=ot(i.gridFormat),u=si(o,t.frameInChunk,y,s,a,B);if(c.queue.writeBuffer(F,0,u.chunkPrefix),!u.sameFormat&&u.activeFrame&&c.queue.writeBuffer(n,0,u.activeFrame),h=t.frameInChunk+1,v=i.generations.slice(0,t.frameInChunk+1),b=v[t.frameInChunk],be=b,u.sameFormat){let p=c.createCommandEncoder({label:d.recordingRestoreCopyEncoder});p.copyBufferToBuffer(F,t.frameInChunk*y,n,0,y),c.queue.submit([p.finish()])}let l=C.splice(t.sealedIndex);qo(l.map(p=>p.filename))}Pr(ee,C,v),we(),Yt(),V(!0),H()}}function xa(){Kt(),ir(!0),!R||Ht()?(Xt(),me++,R&&er()&&(h>=T&&nr(),tr(b)),ke(!1)):ke(!0),V(!0),H()}function Ba(e){self.postMessage({type:"stepping",active:!0}),ir(!0),jt(qt(),{pacing:{kind:"max"},stopCondition:{kind:"targetGeneration",generation:b+e},restoreAfterStop:{running:P,targetStepDuration:ne}})}function Pa(e){e.count===1?xa():Ba(e.count)}function Ea(){ki(g?.request.restoreAfterStop?.running??P)}function ka(e){let r=C.find(t=>t.filename===e.filename);r&&(r.codec=e.codec,r.storedBytes=e.storedBytes,r.gridFormat=e.gridFormat,ee.chunks=[...C],we(),qr())}function wa(){let e=C.filter(r=>r.codec===Me).map(r=>({filename:r.filename,rawBytes:r.uncompressedBytes,blockCount:r.blockCount,cols:_,rows:x,rawGridFormat:r.gridFormat,storageGridFormat:Ie(cr(Hr.tribes.length))}));self.postMessage({type:"uncompressedChunks",chunks:e})}async function Aa(e){switch(e.type){case"init":await fa(e);break;case"setLiveMetrics":pa(e);break;case"setRuleset":await ma(e);break;case"setRunning":ba(e);break;case"setSpeed":ga(e);break;case"camera":ha(e);break;case"resize":Sa(e);break;case"draw":ya(e);break;case"brushPreview":Ta(e);break;case"getSnapshot":await Ca();break;case"loadSnapshot":await Ma(e);break;case"setRecording":va(e);break;case"getRecording":await Ra();break;case"stepBack":await _a(e);break;case"stepForward":Pa(e);break;case"cancelStepping":Ea();break;case"updateChunkCodec":ka(e);break;case"getUncompressedChunks":wa();break}}self.onmessage=async e=>{await Aa(e.data)};
