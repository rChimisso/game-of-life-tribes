...
`}function Ki(e){let{cols:r,rows:t,topology:n,gridFormat:o,dispatchPlan:i}=e,s=n===C?"x + 1u < COLS":"true",a=n===C?"y + 1u < ROWS":"true";return`
@group(0) @binding(0) var<storage, read> grid: array<u32>;
