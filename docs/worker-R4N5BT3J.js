var Vt="goltTimestampedConsoleInstalled";function Ai(){let e=globalThis;e[Vt]||(e[Vt]=!0,Vr("info"),Vr("warn"),Vr("error"),console.log=console.info.bind(console))}function Vr(e){let r=console[e].bind(console);console[e]=(...t)=>{r(`[${new Date().toISOString()}]`,...t)}}Ai();var Zt=`// Render shader: draws the grid as a full-screen quad.\r
