...
export const GPU_LABELS = {
  ...
  simulationBindGroupAtoB: 'simulation bind group A to B',
  simulationBindGroupBtoA: 'simulation bind group B to A',
  simulationParameterBuffer: 'simulation parameter buffer',
  simulationParameterBindGroup: 'simulation parameter bind group',
  ...
  webengineDevice: 'webengine WebGPU device',
  recordedGpuMetricsDevice: 'recorded GPU Metrics device',
  mp4ConversionDevice: 'MP4 conversion device',
