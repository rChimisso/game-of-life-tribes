...
| MP4 max dimension             |                              $4\,096$ px | Keeps video output inside practical encoder limits.                   |
| MP4 small-grid reference      |                              $1\,080$ px | Upscales small grids to more useful video size.                       |
